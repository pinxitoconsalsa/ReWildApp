...
CREATE TABLE "Tree" (
    ...
    "lat" REAL NOT NULL,
    "lng" REAL NOT NULL,
    "co2PerYear" REAL NOT NULL DEFAULT 0.2,
    "photoUrl" TEXT,
...
CREATE TABLE "CoursePurchase" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "CoursePurchase_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "CoursePurchase_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "Course" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "EventJoin" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "EventJoin_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "EventJoin_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "NFTCertificate" (
    ...
    "lat" REAL NOT NULL,
    "lng" REAL NOT NULL,
    "co2PerYear" REAL NOT NULL,
    "txHash" TEXT,
    "chain" TEXT NOT NULL DEFAULT 'polygon',
    "mintedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "NFTCertificate_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "NFTCertificate_treeId_fkey" FOREIGN KEY ("treeId") REFERENCES "Tree" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "CarbonCalcLog" (
    ...
    "diet" REAL NOT NULL,
    "hogar" REAL NOT NULL,
    "totalTonnes" REAL NOT NULL,
    "treesNeeded" INTEGER NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "CarbonCalcLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
